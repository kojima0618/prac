    ...
    class Node:
        ...
        def heuristic(self, num):
            if num == 0:
                ...
                count = sum(self.puzzle.board[i][j] != self.puzzle.edgelength * i + j + 1 for i in range(self.puzzle.edgelength) for j in range(self.puzzle.edgelength))
